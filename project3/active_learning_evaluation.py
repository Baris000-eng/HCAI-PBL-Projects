...
print(f"The active learning model's test accuracy at Query 0 (Initialization) is: {initial_al_accuracy:.4f}\n")
...
for i in range(num_queries_to_run):
    ...
    print(f"Query {i+1}/{num_queries_to_run} | "
          f"Test Accuracy: {update_result['current_test_accuracy']:.4f} | "
